...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/late-bird-5b56#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/late-bird-5b56
```

A live public deployment of this template is available at [https://late-bird-5b56.templates.workers.dev](https://late-bird-5b56.templates.workers.dev)
